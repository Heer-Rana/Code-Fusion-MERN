...
function Sidebar() {
    ...
    // Removed destructuring of activityState, setActivityState from useAppContext()
    // Removed destructuring of socket from useSocket()
    // Removed destructuring of isMobile from useWindowDimensions()
    // Removed showTooltip state

    // The changeState function has been entirely removed.
    ...
    return (
        <aside className="flex w-full md:h-full md:max-h-full md:min-h-full md:w-auto">
            ...
            >
                ...
                {/* The entire block for the activity state toggle button and its tooltip is removed. */}
            </div>
            <div
